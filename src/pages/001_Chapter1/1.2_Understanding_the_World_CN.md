...
<style>
  ...
  /* 机构投资者样式 */
  .institution-section, .intermediary-section {
    display: grid;
  ...
  .institution-item, .intermediary-item {
    background: var(--card-bg);
  ...
  .institution-item:hover, .intermediary-item:hover {
    transform: translateY(-3px);
    box-shadow: 0 8px 20px rgba(0,0,0,0.15);
  }

  .institution-item h4, .intermediary-item h4 {
    color: var(--primary-color);
    margin-bottom: 1rem;
    font-size: 1.2rem;
    display: flex;
  ...
  .lifecycle-stages h5, .competition-framework h5, .financial-metrics h5, .moat-analysis h5 {
    color: var(--primary-color);
    margin-bottom: 0.8rem;
    font-size: 1rem;
  }
  ...
  .ai-trends h5, .green-trends h5, .population-trends h5 {
    color: #2e7d32;
    margin-bottom: 0.8rem;
    font-size: 1rem;
  }
  ...
  [data-theme="dark"] .summary-item h4,
