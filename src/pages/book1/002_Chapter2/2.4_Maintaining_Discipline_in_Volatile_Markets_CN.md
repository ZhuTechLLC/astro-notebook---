...
<div class="status-card orange" style="margin-top:1.5rem;">
<div class="status-header">
<h4>📎 2026-07 延伸：接到 TRQuant 纪律链</h4>
<div class="status-label">增补，不改上文练习</div>
</div>
<div class="status-content">
<p>本章纪律练完后，用导航页的系统对接清单勾选：Reflection → Precommit → Event Lake。总览见 <a href="/book1/002_Chapter2_Investment_Psychology_and_Risk_Management_CN">第二章导航 · 2026-07 系统对接清单</a> 与 <a href="/trquant_northstar_alignment_CN">NorthStar 对齐</a>。</p>
<p>自动交易是长期目标；当前阶段先把纪律对象落进系统，再谈生产自动下单。</p>
</div>
</div>
